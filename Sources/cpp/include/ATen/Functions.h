...
TORCH_API inline at::Tensor diagonal_backward(const at::Tensor & grad, at::IntArrayRef input_sizes, int64_t offset, int64_t dim1, int64_t dim2) {
    return at::_ops::diagonal_backward::call(grad, input_sizes, offset, dim1, dim2);
}
...
TORCH_API inline at::Tensor select_backward(const at::Tensor & grad, at::IntArrayRef input_sizes, int64_t dim, int64_t index) {
    return at::_ops::select_backward::call(grad, input_sizes, dim, index);
}
...
TORCH_API inline at::Tensor slice_backward(const at::Tensor & grad, at::IntArrayRef input_sizes, int64_t dim, int64_t start, int64_t end, int64_t step) {
    return at::_ops::slice_backward::call(grad, input_sizes, dim, start, end, step);
}
...
TORCH_API inline at::Tensor cross_entropy_loss(const at::Tensor & self, const at::Tensor & target, const c10::optional<at::Tensor> & weight={}, int64_t reduction=at::Reduction::Mean, int64_t ignore_index=-100) {
    return at::_ops::cross_entropy_loss::call(self, target, weight, reduction, ignore_index);
}
...
TORCH_API inline at::Tensor _cumsum(const at::Tensor & self, int64_t dim) {
    return at::_ops::_cumsum::call(self, dim);
}

// aten::_cumsum.out(Tensor self, int dim, *, Tensor(a!) out) -> Tensor(a!)
TORCH_API inline at::Tensor & _cumsum_out(at::Tensor & out, const at::Tensor & self, int64_t dim) {
    return at::_ops::_cumsum_out::call(self, dim, out);
}

// aten::_cumsum.out(Tensor self, int dim, *, Tensor(a!) out) -> Tensor(a!)
TORCH_API inline at::Tensor & _cumsum_outf(const at::Tensor & self, int64_t dim, at::Tensor & out) {
    return at::_ops::_cumsum_out::call(self, dim, out);
}

// aten::_cumprod(Tensor self, int dim) -> Tensor
TORCH_API inline at::Tensor _cumprod(const at::Tensor & self, int64_t dim) {
    return at::_ops::_cumprod::call(self, dim);
}

// aten::_cumprod.out(Tensor self, int dim, *, Tensor(a!) out) -> Tensor(a!)
TORCH_API inline at::Tensor & _cumprod_out(at::Tensor & out, const at::Tensor & self, int64_t dim) {
    return at::_ops::_cumprod_out::call(self, dim, out);
}

// aten::_cumprod.out(Tensor self, int dim, *, Tensor(a!) out) -> Tensor(a!)
TORCH_API inline at::Tensor & _cumprod_outf(const at::Tensor & self, int64_t dim, at::Tensor & out) {
    return at::_ops::_cumprod_out::call(self, dim, out);
}
...
TORCH_API inline ::std::tuple<at::Tensor,at::Tensor> linalg_cholesky_ex(const at::Tensor & self, bool check_errors=false) {
    return at::_ops::linalg_cholesky_ex::call(self, check_errors);
}

// aten::linalg_cholesky_ex.L(Tensor self, *, bool check_errors=False, Tensor(a!) L, Tensor(b!) info) -> (Tensor(a!) L, Tensor(b!) info)
TORCH_API inline ::std::tuple<at::Tensor &,at::Tensor &> linalg_cholesky_ex_out(at::Tensor & L, at::Tensor & info, const at::Tensor & self, bool check_errors=false) {
    return at::_ops::linalg_cholesky_ex_L::call(self, check_errors, L, info);
}

// aten::linalg_cholesky_ex.L(Tensor self, *, bool check_errors=False, Tensor(a!) L, Tensor(b!) info) -> (Tensor(a!) L, Tensor(b!) info)
TORCH_API inline ::std::tuple<at::Tensor &,at::Tensor &> linalg_cholesky_ex_outf(const at::Tensor & self, bool check_errors, at::Tensor & L, at::Tensor & info) {
    return at::_ops::linalg_cholesky_ex_L::call(self, check_errors, L, info);
}

// aten::linalg_cholesky(Tensor self) -> Tensor
TORCH_API inline at::Tensor linalg_cholesky(const at::Tensor & self) {
    return at::_ops::linalg_cholesky::call(self);
}

// aten::linalg_cholesky.out(Tensor self, *, Tensor(a!) out) -> Tensor(a!)
TORCH_API inline at::Tensor & linalg_cholesky_out(at::Tensor & out, const at::Tensor & self) {
    return at::_ops::linalg_cholesky_out::call(self, out);
}

// aten::linalg_cholesky.out(Tensor self, *, Tensor(a!) out) -> Tensor(a!)
TORCH_API inline at::Tensor & linalg_cholesky_outf(const at::Tensor & self, at::Tensor & out) {
    return at::_ops::linalg_cholesky_out::call(self, out);
}
